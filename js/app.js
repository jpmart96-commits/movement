...
const History = {
  ...
  setLoad(exerciseId, set) {
    ...
    // Latest weigh-in (Health or typed), else Settings → Body.
    const bw = ((typeof Vitals !== 'undefined' && Vitals.bodyweight) ? (Vitals.bodyweight() || {}).v : null)
      || ((typeof Profile !== 'undefined') ? Profile.load()?.settings?.bodyweightKg : null) || null;
